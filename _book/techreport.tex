...
{\centering \pdftooltip{\includegraphics[width=8.5in]{figure/Figure08}}{Figure \ref{fig:figure8}} 
...
{\centering \pdftooltip{\includegraphics[width=8.0in]{figure/Figure09}}{Figure \ref{fig:figure9}} 
...
{\centering \pdftooltip{\includegraphics[width=8.5in]{figure/Figure13}}{Figure \ref{fig:figure13}} 
...
\caption{Relationships between in situ 5 m temperatures measured at HL\_06, GULD\_03 and LL\_07 during AZMP and other sampling missions and remotely-sensed sea surface temperatures averaged for the corresponding months/years for the SW HL, GMPA and SW LL satellite areas. Filled circles, squares and triangles represent measurements in April, May and June, respectively, in spring, and in September, October and December, respectively, in fall.}\label{fig:figure16}
\end{figure}
\clearpage
...
\caption{Relationships between in situ measurements of chlorophyll concentrations in the 0 to 10 m depth range at stations throughout the satellite areas (SW LL, GMPA, SW HL) and remotely-sensed sea surface chlorophyll concentrations averaged for the appropriate months/years.}\label{fig:figure28}
\end{figure}
\clearpage
...
\caption{Relationships between the Population Development Index (Abundance CI-III/Abundance CI-VI, \%) for Calanus finmarchicus populations versus sampling date minus spring bloom initiation date (top row), and April sea surface temperature (bottom row), for HL\_06, SW HL and LL\_07, SW LL.}\label{fig:figure33}
\end{figure}
\end{landscapepage}
\clearpage
...
\caption{Abundance of stage CV (filled circles) and stage CIV (open squares) C. finmarchicus versus sampling date at LL\_07, GULD\_03 and HL\_06 in fall between 1999 and 2018. Note that the outlier circled in black from 2017 at LL\_07 was excluded from the only significant correlation between abundance and sampling date.}\label{fig:figure34}
\end{figure}
\clearpage
\end{document}
