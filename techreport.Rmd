...
zoopl <- c("LL\\_07/April", "Year", "Microcalanus", "O. similis", "Pseudocalanus", "Scolecithrocella", "GULD\\_03/April", "Year", "C. hyperboreus", "M. lucens", "HL\\_06/April", "Year", "Clausocalanus", "Pleuromamma", "Pseudocalanus")
...
kbl(ctable7, 
  ...
  # Make the header row bold text
  kableExtra::row_spec(0, bold = TRUE) %>%
  # Make the text bold in three cells in column 1.
  kableExtra::column_spec (1, bold = bold_cell) %>%
...
zoopl <- c("LL\\_07/Fall", "Year", "C. finmarchicus", "Clausocalanus", "Microcalanus", "GULD\\_03/Fall", "Year", "Clausocalanus", "M. lucens", "HL\\_06/Fall", "Year", "C. finmarchicus", "M. clausi", "M. lucens", "O. atlantica", "O. similis", "Paracalanus", "Pleuromamma")
...
```{r figure8, fig.align = "center", fig.cap = "(ref:fig8-caption)", out.width = "8.5in"}
...
```{r figure9, fig.align = "center", fig.cap = "(ref:fig9-caption)", out.width = "8.0in"}
...
```{r figure13, fig.align = "center", fig.cap = "(ref:fig13-caption)", out.width = "8.5in"}
...
(ref:fig28-caption) Relationships between in situ measurements of chlorophyll concentrations in the 0 to 10 m depth range at stations throughout the satellite areas (SW LL, GMPA, SW HL) and remotely-sensed sea surface chlorophyll concentrations averaged for the appropriate months/years.
...
(ref:fig33-caption) Relationships between the Population Development Index (Abundance CI-III/Abundance CI-VI, %) for Calanus finmarchicus populations versus sampling date minus spring bloom initiation date (top row), and April sea surface temperature (bottom row), for HL_06, SW HL and LL_07, SW LL. 
...
(ref:fig34-caption) Abundance of stage CV (filled circles) and stage CIV (open squares) C. finmarchicus versus sampling date at LL_07, GULD_03 and HL_06 in fall between 1999 and 2018. Note that the outlier circled in black from 2017 at LL_07 was excluded from the only significant correlation between abundance and sampling date.
