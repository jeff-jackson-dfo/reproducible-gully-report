...
(ref:fig34-caption) Abundance of stage CV (filled circles) and stage CIV (open squares) _C. finmarchicus_ versus sampling date at LL_07, GULD_03 and HL_06 in fall between 1999 and 2018. Note that the outlier circled in black from 2017 at LL_07 was excluded from the only significant correlation between abundance and sampling date.
