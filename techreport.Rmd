...
guld3s <- c("","0.550**","0.806***","0.611***","")
sg28s <- c("0.598*", "0.838**", "0.790**", "", "")
guld4s <- c("","0.694**","0.835***","0.532*","")
sg23s <- c("","","0.638*","","")
guld3f <- c("","","0.380*","0.541**","")
sg28f <- c("","","0.431*","0.540*","")
guld4f <- c("","","","0.641**","")
sg23f <- c("","","0.533*","","0.471*")
...
csasdown::csas_table(ctable5,
  ...
  kableExtra::row_spec(0, bold = TRUE) %>%
  kableExtra::column_spec (c(1,5), border_right = T)
