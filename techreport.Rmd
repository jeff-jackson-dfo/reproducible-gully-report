...
Here we present the first compilation of the physical, chemical, and biological data collected by the AZMP at the four fixed stations in the Gully MPA. CTD profile data collected from 1999 to 2018 were compiled, and average temperature, salinity, dissolved oxygen, and nutrient and chlorophyll _a_ inventories were evaluated both within and among the four stations. In addition to the shipboard samples and data collected by the AZMP, sea surface temperature and chlorophyll _a_ extracted from satellite-based imagery collected from 1998 to 2018 were also evaluated. While the datasets were deemed insufficient for climatological calculations for which to assess anomalies, changes in oceanographic conditions over the time period sampled were assessed, and significant trends identified.
...
Figures 10 through 12 depict temporal changes in seasonal temperature, salinity, and dissolved oxygen averaged across 5 vertical depth intervals (0 - 50 m, 50 - 100 m, 100 - 400 m, 400 - 750 m, and 750 - near-bottom) over the time series at each station. The 3-layer vertical structure in spring temperature identified in the vertically-averaged CTD profiles (Figure 5) was evident in Figure 10, with cooler near-surface layers (mean $\pm$ SD: 0 - 50 m: 4.02 $\pm$ 2.10 $\degree$C; 50 - 100 m: 6.32 $\pm$ 3.18 $\degree$C), warmer intermediate layers (100 - 400 m: 7.67 $\pm$ 1.46 $\degree$C), and cooler deeper layers (400 - 70 m: 5.18 $\pm$ 0.63 $\degree$C; 750 m - near-bottom: 4.63 $\pm$ 0.30 $\degree$C) across all stations. At GULD_03, the depth of the cooler near-surface layer extended to 100 m, but was shallower (0 - 50 m) at the stations across the Gully mouth (SG_28, GULD_04, and SG_23). 
...
Although SSTs in the GMPA did not show significant trends in spring over the 1998 - 2018 period, _in situ_ 5 m and 0 - 200 m average April temperatures showed significant positive trends for the 1999 - 2018 period at LL_07, and 0 - 200 m temperatures at GULD_03 showed a significant positive trend in at GULD_03 for years sampled between 2007 and 2018. 
...
7.	Proportions of young stages (CI-III) _Calanus finmarchicus_ in April increased with increasing near-surface temperature at LL_07 but decreased with increasing temperature at HL_06 and appeared to be influenced by the timing of sampling relative to the timing of the start of the spring bloom 
8.	Abundances of late stage (CV) _Calanus finmarchicus_ at HL_06 and LL_07 in fall increased with increasing (later) sampling date and were not related to temperature at the depths of maximum abundance (400 - 600 m at HL_06, 200 - 400 m at LL_07 and GULD_03)
