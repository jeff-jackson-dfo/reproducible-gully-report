...
```{r figure5, fig.align = "center", fig.cap = "(ref:fig5-caption)", out.width = "7.0in"}
...
```{r figure6, fig.align = "center", fig.cap = "(ref:fig6-caption)", out.width = "7.0in"}
...
```{r figure7, fig.align = "center", fig.cap = "(ref:fig7-caption)", out.width = "7.0in"}
...
```{r figure9, fig.align = "center", fig.cap = "(ref:fig9-caption)", out.width = "7.5in"}
