...
Hopefully the work captured in this repository will be a solid foundation for reproducing future technical reports on oceanographic monitoring in the Gully.  Future reports on oceanographic monitoring data will undoubtedly not be as comprehensive as this first one. Therefore it should be very doable for the next iteration of this code base to generate the entire document dynamically; including all of the figures.

## Reproducing the Tech Report

To reproduce the report stored in this repository, the user must have R and RStudio installed on their computer.
