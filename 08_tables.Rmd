...
<!-- stations <- list(c("GULD_03", "GULD_04", "SG_23", "SG_28"), c("GULD_03", "GULD_04", "SG_23", "SG_28")) -->
<!-- nprof <- list(c(12, 10, 7, 8), c(15,11,9,10)) -->
<!-- years <- list(list(c(2000,2018), c(2000,2018), c(2008,2017), c(2008,2018)), list(c(2000,2018), c(2000,2018), c(2007,2018), c(2007,2018))) -->

<!-- header <- c("Season", "Station", "Number of CTD Profiles", "Year") -->

<!-- ctable <- tibble(seasons, stations, nprof, years) -->
